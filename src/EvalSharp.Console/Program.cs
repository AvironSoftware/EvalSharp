using EvalSharp;
using EvalSharp.Console;
using EvalSharp.Scoring;
using System.Text.Json;
using System.Text.Json.Serialization;


var tests = SummaryInputOutput.TestDataSet.Take(2);
var evaluator = new Evaluator<SummaryInputOutput>(ChatClient.GetInstance(), tests, test => new EvaluatorTestData
{
...
public class SentimentInputOutput
{
    ...
    public static SentimentInputOutput[] TestDataSet = JsonSerializer.Deserialize<SentimentInputOutput[]>(
        """
        [
