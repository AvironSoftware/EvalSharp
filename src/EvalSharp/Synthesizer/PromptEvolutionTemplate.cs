...
{
    internal static class PromptEvolutionTemplate
    {
    ...
    public static string ReasoningEvolution(string input) => $$"""
{{BaseInstruction}}
...
""";
        ...
        public static string ConcretizingEvolution(string input) => $$"""
{{BaseInstruction}}
...
""";
        ...
        public static string ConstrainedEvolution(string input) => $$"""
{{BaseInstruction}}
...
""";
        ...
        public static string ComparativeQuestionEvolution(string input) => $$"""
{{BaseInstruction}}
...
""";
        ...
        public static string HypotheticalScenarioEvolution(string input) => $$"""
{{BaseInstruction}}
...
""";
        ...
        public static string InBreadthEvolution(string input) => $$"""
{{BaseInstruction}}
