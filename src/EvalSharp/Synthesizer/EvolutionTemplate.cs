...
{
    internal class EvolutionTemplate
    {
        private const string BaseInstruction = $$"""
            I want you to act as an input rewriter.
            ...
            """;
        public static string MultiContextEvolution(string input, List<string>? context)
        {
...
""";
        ...
        public static string ReasoningEvolution(string input, List<string>? context)
        {
            var formattedContext = context.ToFormattedList();
            return $$"""
{{BaseInstruction}}
...
""";
        ...
        public static string ConcretizingEvolution(string input, List<string> context)
        {
            var formattedContext = context.ToFormattedList();
            return $$"""
{{BaseInstruction}}
...
""";
        ...
        public static string ConstrainedEvolution(string input, List<string> context)
        {
            var formattedContext = context.ToFormattedList();
            return $$"""
{{BaseInstruction}}
...
""";
        ...
        public static string ComparativeQuestionEvolution(string input, List<string> context)
        {
            var formattedContext = context.ToFormattedList();
            return $$"""
{{BaseInstruction}}
...
""";
        ...
        public static string HypotheticalEvolution(string input, List<string> context)
        {
            var formattedContext = context.ToFormattedList();
            return $$"""
{{BaseInstruction}}
...
""";
        ...
        public static string InBreadthEvolution(string input, List<string> context)
        {
            var formattedContext = context.ToFormattedList();
            return $$"""
{{BaseInstruction}}
